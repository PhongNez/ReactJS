...
class SearchProduct extends Component {
    ...
    timKiemTheoDanhMuc = async (event) => {
        ...
        let response = await axios.get(`http://localhost:8081/api/v1/admin/product?id=${id_category}`)
    ...
    render() {
        return (
            <>
                ...
                <div className='contain-main-search'>
                    <div className="main-search-2">
                        <p className='loc-danh-muc'>Lọc theo danh mục:</p>
                        <select className='select-category-2' onChange={(event) => this.handleOnChangeInput(event)}
