            ...
            <>
                <nav aria-label="Page navigation example" className='main-phantrang'>
                    <ul className="pagination phantrang">
                        <li className="page-item"><a className="page-link" href="#" onClick={() => this.props.handleListCategory(this.props.pageHienTai - 1)}>Trước</a></li>
                        {
                            listCategory && listCategory.slice(0, Math.ceil(this.props.pageLength / page_size)).map((item, index) => {
                                return (
                                    <li className="page-item" > <a className="page-link" onClick={() => this.props.handleListCategory(index + 1)} href="#">{index + 1}</a></li>
                        ...
                        <li className="page-item"><a className="page-link" onClick={() => this.props.handleListCategory(this.props.pageHienTai + 1)} href="#">Sau</a></li>
                    </ul>
                </nav>
            </>
        )
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(PhanTrangCategory));
